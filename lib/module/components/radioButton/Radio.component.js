...
export const RadioComponent = props => {
  ...
  const [selectedRadio, setSelectedRadio] = useState(props.defaultSelect ? props.defaultSelect : props.optionNames[0]);
  const selectOption = optionName => {
    props.setCurrentSelected(optionName);
    setSelectedRadio(optionName);
  };
  return /*#__PURE__*/React.createElement(React.Fragment, null, props.optionNames.map((item, index) => /*#__PURE__*/React.createElement(TouchableOpacity, {
  ...
  }, textAlign === 'left' ? /*#__PURE__*/React.createElement(Text, {
    style: {
      fontSize: fontSize,
      color: textColor,
      flex: 1
    }
  }, item) : null, /*#__PURE__*/React.createElement(View, {
    style: [RadioStyles.radio, {
      borderColor: outerBgColor,
      height: 28,
      width: 28
    }]
  }, selectedRadio == item ? /*#__PURE__*/React.createElement(View, {
    style: [RadioStyles.radioBg, {
      backgroundColor: innerBgColor,
      height: 15,
      width: 15
    }]
  }) : null), textAlign === 'right' ? /*#__PURE__*/React.createElement(Text, {
    style: {
      fontSize: fontSize,
      color: textColor,
      flex: 1
