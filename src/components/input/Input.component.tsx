 ...
 */
export const TextInputComponent = ({label, value, onChange, placeholder = "Type Here",supportingText="", placeholderTextColor = "grey", secureTextEntry = false, showSupportingText = false, onBlur,containerStyle,inputstyle,labelstyle,supportingtextstyle,}: TextInputComponentProps) => {
